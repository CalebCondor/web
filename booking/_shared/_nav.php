  ...
  <nav class="bg-[#253b8e] rounded-[22px] shadow-2xl overflow-hidden">
    <div class="flex divide-x divide-white/20">
      ...
      <a href="<?= APP_BASE ?>/index.php"
        ...
        <span class="text-white/70 text-[9px] font-semibold whitespace-nowrap">Home</span>
      </a>
      ...
      <a href="<?= APP_BASE ?>/step6.php"
        ...
        <span class="text-white/70 text-[9px] font-semibold whitespace-nowrap">My Documents</span>
      </a>
      ...
      <a href="<?= APP_BASE ?>/profile.php"
        ...
        <span class="text-white/70 text-[9px] font-semibold whitespace-nowrap">Profile</span>
      </a>
      ...
      <a href="<?= APP_BASE ?>/logout.php"
        ...
        <span class="text-white/70 text-[9px] font-semibold whitespace-nowrap">Sign Out</span>
      </a>
