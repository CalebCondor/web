<?php
define('API_BASE', getenv('API_BASE') !== false && getenv('API_BASE') !== '' ? getenv('API_BASE') : 'https://islandmedpr.com/notarize/api/v1');
define('APP_BASE', getenv('APP_BASE') !== false && getenv('APP_BASE') !== '' ? getenv('APP_BASE') : '');
