...
<div class="w-full md:max-w-sm min-h-screen bg-slate-50 flex flex-col md:shadow-2xl relative">
      ...
      <div class="px-4 pt-4 pb-2">
        ...
        <?php foreach ([
          ...
          <div class="flex justify-between items-center py-2.5 border-b border-slate-100 last:border-0">
            ...
            <span class="text-sm font-bold text-slate-900"><?= htmlspecialchars($val) ?></span>
          </div>
        <?php endforeach; ?>
      </div>
    </div>
      ...
      <div class="px-4 pt-4 pb-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-slate-400">CLIENTE DEMO</p>
          </div>
          <span class="bg-yellow-100 text-yellow-700 text-[10px] font-extrabold px-2 py-1 rounded-lg">DEMO</span>
        </div>
      </div>
    </div>
  ...
  <!-- Fixed bottom bar -->
  <div class="fixed bottom-0 left-0 right-0 md:absolute bg-white border-t border-slate-200 px-4 py-4 flex gap-3"
